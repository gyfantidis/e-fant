...
VALUES
    (1, 2),   -- Pizza Place (restaurant_id: 13) is associated with category_id 7 (Vegetarian Menu)
    (2, 3),   -- Burger Joint (restaurant_id: 14) is associated with category_id 8 (Souvlaki)
    (3, 4),   -- Greek Taverna (restaurant_id: 15) is associated with category_id 2 (Pizza)
    (4,5),   -- Asian Delight (restaurant_id: 16) is associated with category_id 3 (Burgers)
    (5, 6),   -- Coffee Haven (restaurant_id: 17) is associated with category_id 5 (Asian Food)
    (6, 7),   -- Green Bites (restaurant_id: 18) is associated with category_id 6 (Coffees)
    (7, 8),   -- Sizzling Souvlaki (restaurant_id: 19) is associated with category_id 7 (Vegetarian Menu)
    (8, 2),   -- Italian Delights (restaurant_id: 20) is associated with category_id 2 (Pizza)
    (9, 3),   -- Tasty Tacos (restaurant_id: 21) is associated with category_id 3 (Burgers)
    (10, 5),   -- Sushi Express (restaurant_id: 22) is associated with category_id 5 (Asian Food)
    (11, 2),   -- Pasta Paradise (restaurant_id: 23) is associated with category_id 9 (Italian Food)
    (12, 7),   -- Healthy Bowls (restaurant_id: 24) is associated with category_id 7 (Vegetarian Menu)
    (13, 4),   -- Seafood Sensation (restaurant_id: 25) is associated with category_id 8 (Souvlaki)
    (14, 4),   -- Bistro Brunch (restaurant_id: 26) is associated with category_id 2 (Pizza)
    (15, 3),   -- BBQ Grill (restaurant_id: 27) is associated with category_id 3 (Burgers)
    (16, 4),   -- Mediterranean Flavors (restaurant_id: 28) is associated with category_id 4 (Greek Food)
    (17, 5),   -- Steakhouse Grill (restaurant_id: 29) is associated with category_id 5 (Asian Food)
    (18, 6),   -- Tandoori Express (restaurant_id: 30) is associated with category_id 6 (Coffees)
    (19, 7),   -- Thai Spice (restaurant_id: 31) is associated with category_id 7 (Vegetarian Menu)
    (20, 8),   -- French Fusion (restaurant_id: 32) is associated with category_id 8 (Souvlaki)
    (21, 3),   -- Tapas Trail (restaurant_id: 33) is associated with category_id 2 (Pizza)
    (22, 3),   -- Middle Eastern Feast (restaurant_id: 34) is associated with category_id 3 (Burgers)
    (23, 5),   -- Indian Spice (restaurant_id: 35) is associated with category_id 5 (Asian Food)
    (24, 7),   -- Bakery Bliss (restaurant_id: 36) is associated with category_id 7 (Vegetarian Menu)
    (25, 8),   -- Fusion Fare (restaurant_id: 37) is associated with category_id 8 (Souvlaki)
    (26, 2),   -- Cajun Creations (restaurant_id: 38) is associated with category_id 2 (Pizza)
    (27, 3),   -- Delightful Desserts (restaurant_id: 39) is associated with category_id 3 (Burgers)
    (28, 5),   -- Crispy Crusts (restaurant_id: 40) is associated with category_id 5 (Asian Food)
    (29, 7),   -- Comfort Classics (restaurant_id: 41) is associated with category_id 7 (Vegetarian Menu)
    (30, 8)    -- Vietnamese Vibes (restaurant_id: 42) is associated with category_id 8 (Souvlaki)
    ON CONFLICT DO NOTHING;
